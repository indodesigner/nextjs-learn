...
const AboutIndia = () => {
  ...
  return (
    <section className="container">
      ...
      <div className="grid grid-cols-1 place-items-center lg:grid-cols-2 gap-4 bg-neutral-100 dark:bg-neutral-700 bg-opacity-30 dark:bg-opacity-30 dark:border-[1px] dark:border-neutral-400 dark:border-opacity-20 shadow-lg p-4 rounded-2xl">
        <Image
          src={IndiaMapImage}
          width={500}
          height={400}
