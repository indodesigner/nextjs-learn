...
const AboutPage = () => {
  return (
    <div className="container mt-0 sm:mt-8 lg:mt-28">
      ...
      <div className="bg-neutral-200 dark:bg-neutral-800 p-6 my-8 rounded-2xl">
        <h3 className="font-bold text-2xl mb-2">Get in Touch</h3>
        <p>
          Ready to embark on a personalized journey with [Your Business Name]?
          Contact us today to start planning your dream vacation, whether it's a
