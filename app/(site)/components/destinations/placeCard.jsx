          ...
          >
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 group-hover:bg-neutral-800 group-hover:backdrop-blur-md group-hover:bg-opacity-40 rounded-md w-full h-full flex justify-center items-center">
                <h5 className="text-center text-neutral-100 dark:text-white  px-2 text-lg md:text-xl font-extrabold mt-1 mb-1 line-clamp-2 group-hover:gradient-text transition duration-200">
                  {language === "english"
                    ? place.placeName
