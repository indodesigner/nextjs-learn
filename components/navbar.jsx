...
export default function Navbar() {
  return (
    <div className="flex items-center justify-center py-4 sticky top-0 z-50 bg-neutral-600 backdrop-filter backdrop-blur-xl bg-opacity-30 min-w-full scroll-auto">
